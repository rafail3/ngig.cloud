...
// Text and code files get no thumbnail at all: what identifies them is the
// FORMAT, and that is derivable from the filename. Rendering it into an image,
// uploading that image and reading the file back to make it would all be work
// to store something already known — the list draws the badge itself.
