...
export const NOTIFICATION_CATALOG: NotificationTypeMeta[] = [
  ...
  { key: "transfer_request", label: "Cerere de transfer primită", description: "Anunță utilizatorul când altcineva îi trimite fișiere/foldere direct — trebuie să accepte sau să refuze cererea.", audience: "user",
    defaultTitle: "📥 Cerere de transfer", defaultBody: "{utilizator} vrea să-ți trimită {elemente}.", vars: ["utilizator", "elemente"] },
  { key: "transfer_accepted", label: "Transfer acceptat", description: "Anunță expeditorul când destinatarul a acceptat transferul lui.", audience: "user",
    defaultTitle: "✅ Transfer acceptat", defaultBody: "{utilizator} a acceptat transferul tău.", vars: ["utilizator"] },
  { key: "transfer_declined", label: "Transfer refuzat", description: "Anunță expeditorul când destinatarul a refuzat transferul lui.", audience: "user",
    defaultTitle: "❌ Transfer refuzat", defaultBody: "Destinatarul a refuzat transferul tău.", vars: [] },
  { key: "transfer_expired", label: "Transfer expirat", description: "Anunță expeditorul când cererea lui de transfer a expirat neacceptată (după 7 zile).", audience: "user",
    defaultTitle: "⏱️ Transfer expirat", defaultBody: "Cererea ta de transfer a expirat fără să fie acceptată.", vars: [] },
  // --- Admin events --------------------------------------------------------
