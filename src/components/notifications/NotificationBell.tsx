...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 flex max-h-[70vh] w-80 max-w-[calc(100vw-1.5rem)] flex-col overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900 shadow-xl">
            ...
            {items.length === 0 ? (
              ...
              items.map((n) => (
                <button
                  ...
                  type="button"
                  onClick={() => openItem(n)}
                  className={`flex w-full gap-2.5 border-b border-zinc-800/70 px-4 py-3 text-left transition hover:bg-zinc-800/50 ${
